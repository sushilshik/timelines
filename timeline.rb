...
if ARGV[2] != nil && ARGV[2].length > 0
	appendLine = ARGV[2].dup.force_encoding("cp1251").encode("cp866")
...
if ARGV[3] != nil && ARGV[3].length > 0 && ARGV[3] == "move_pdf" && File.directory?(pdf_goal_dir)
